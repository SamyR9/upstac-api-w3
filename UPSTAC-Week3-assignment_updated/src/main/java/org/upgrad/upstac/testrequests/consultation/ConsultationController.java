...
public class ConsultationController {
    ...
    public List<TestRequest> getForConsultations()  {
        ...
        return testRequestQueryService.findBy(RequestStatus.LAB_TEST_COMPLETED); // list of test request with complete status returned
    ...
    public List<TestRequest> getForDoctor()  {
        ...
        User user = userLoggedInService.getLoggedInUser(); //logged in user stored
        return testRequestQueryService.findByDoctor(user); //list of test request for logged in doctor returned
    ...
    public TestRequest assignForConsultation(@PathVariable Long id) {
        ...
        User doctor =userLoggedInService.getLoggedInUser(); //logged in user stored
        TestRequest result = testRequestUpdateService.assignForConsultation(id,doctor); //assign for consultation called to assign selected test to doctor
        return result;
    ...
    public TestRequest updateConsultation(@PathVariable Long id,@RequestBody CreateConsultationRequest testResult) {
        ...
        try {
            User doctor=userLoggedInService.getLoggedInUser(); //logged in user stored
            TestRequest request = testRequestUpdateService.updateConsultation(id,testResult,doctor); //update consultation called to update doctor's input
            return request;
